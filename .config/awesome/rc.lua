...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "n", function () awful.spawn.with_shell("tdrop -a -w 43% -y 30% -x 27% marktext ~/github/caz-iii/notes") end,
    ...
    -- Bash Scripts
    awful.key({ modkey }, "d", function () awful.spawn.with_shell("bash ~/bash/dashboard.sh") end,
              {description = "dashboard", group = "launcher"}), 
    awful.key({ modkey }, "p", function () awful.spawn.with_shell("bash ~/bash/finance.sh") end,
