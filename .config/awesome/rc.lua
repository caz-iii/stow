...
globalkeys = mytable.join(
    ...
    awful.key({ altkey }, "d", function () awful.spawn.with_shell("bash ~/dev/bash/dashboard.sh") end,
              {description = "dashboard", group = "launcher"}), 
    awful.key({ altkey }, "p", function () awful.spawn.with_shell("bash ~/dev/bash/finance.sh") end,
              {description = "pay - finance", group = "launcher"}),
    awful.key({ altkey }, "b", function () awful.spawn.with_shell("bash ~/dev/bash/docker.sh") end,
              {description = "pay - finance", group = "launcher"}), 
